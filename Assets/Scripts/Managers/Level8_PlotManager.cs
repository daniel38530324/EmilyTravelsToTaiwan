...
public class Level8_PlotManager : MonoBehaviour
{
    public static Level8_PlotManager Instance{get; private set;}
    ...
    private void Start() {
        AudioManager.Instance.PlayMusic("Level8Plot");
    }
    ...
    public void NextLevel(){
        GameManager.Instance.ChangeScene("Level8_Game");
    }
