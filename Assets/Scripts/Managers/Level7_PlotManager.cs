...
public class Level7_PlotManager : MonoBehaviour
{
    public static Level7_PlotManager Instance{get; private set;}
    ...
    private void Start() {
        AudioManager.Instance.PlayMusic("Level7Plot");
    }
    ...
    public void ChangeBackground(){
        ...
        AudioManager.Instance.PlayMusic("Level7Plot2");
    }

    public void NextLevel(){
        GameManager.Instance.ChangeScene("Level7_Game");
    }
